...
for i = 1:pasos_totales
    ...
    line([joint_1(1) joint_2(1)], [joint_1(2) joint_2(2)], [0 0], "Color", "red", "LineWidth", 2, "LineStyle", "--");
    line([joint_2(1) EF(1)], [joint_2(2) EF(2)], [0 0], "Color", "red", "LineWidth", 2, "LineStyle", "--");
